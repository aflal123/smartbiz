        ...
        <div className="flex-1 p-4 overflow-y-auto grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-4 gap-3">
          {products.length === 0 ? (
            <div className="col-span-full flex flex-col items-center justify-center py-16 text-center text-slate-400">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-slate-100 text-slate-900 mb-3">
              ...
              <Link href="/products">
                <Button className="bg-black hover:bg-slate-800 text-white font-medium gap-2 text-xs">
                ...
                <button
                  ...
                  className={`group relative flex flex-col justify-between p-3.5 rounded-xl border text-left transition-all cursor-pointer ${
                    isOutOfStock
                      ...
                      : "border-slate-200 bg-white hover:border-slate-900 hover:shadow-md active:scale-[0.98]"
                  }`}
                >
                  <div>
                  ...
                  <div className="mt-3 flex items-center justify-between pt-2 border-t border-slate-100">
                    ...
                    />
                    <div className="h-6 w-6 rounded-md bg-black text-white flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
        ...
        <div className="p-4 border-t border-slate-100 bg-slate-50/50 space-y-3">
          <div className="space-y-1.5 text-xs text-slate-600">
            ...
            <div className="flex justify-between pt-2 border-t border-slate-200 text-base font-bold text-slate-900">
              ...
              <MoneyDisplay amount={grandTotal} className="text-slate-900 text-lg font-black" />
            </div>
          </div>
          ...
          <Button
            ...
            className="w-full h-12 bg-black hover:bg-slate-800 text-white font-bold text-base shadow-sm gap-2"
          >
        ...
        <DialogContent className="max-w-md">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-2.5 py-1 text-xs rounded border border-slate-300 bg-slate-100 hover:bg-slate-200 font-semibold text-slate-800"
                  >
                    Exact
                  </button>
                </div>
          ...
          <DialogFooter className="mt-4">
            ...
            <Button
              ...
              className="bg-black hover:bg-slate-800 text-white font-bold"
            >
